...
<head>
    <title>My Participation Status</title>
    <style>
        .status-card {
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                ...
                <h1 class="text-white mb-4 pb-2">My Status.</h1>
...
<div class="container mt-5">
    <h2 class="mb-4">My Participation Status</h2>

    <?php $__empty_1 = true; $__currentLoopData = $participations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $participation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php if($participation->user_id === auth()->id()): ?>
        <div class="status-card">
            <h5><?php echo e($participation->program->title); ?></h5>
            <p><strong>Status:</strong> 
                <?php if($participation->status === 'accepted'): ?>
            ...
            <?php if($participation->status === 'rejected' && $participation->rejection_reason): ?>
                <p><strong>Rejection Reason:</strong> <?php echo e($participation->rejection_reason); ?></p>
            <?php endif; ?>

            <?php if($participation->status === 'accepted' && $participation->program->report): ?>
                <a href="<?php echo e(asset($participation->program->report)); ?>" class="btn btn-primary" target="_blank">Download Report</a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fyp2\UTMConnect+\resources\views/participation_status.blade.php ENDPATH**/ ?>
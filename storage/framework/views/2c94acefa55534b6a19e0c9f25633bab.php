    ...
    <div class="container">
        <div class="row">
            ...
            <div class="event-container">
                ...
                <!-- Trigger image -->
                <img src="<?php echo e(asset($program->poster)); ?>"
                     alt="Program Poster"
                     class="event-image"
                     style="cursor: pointer"
                     data-bs-toggle="modal"
                     data-bs-target="#posterModal<?php echo e($program->id); ?>">

                <!-- Poster Modal -->
                <div class="modal fade" id="posterModal<?php echo e($program->id); ?>" tabindex="-1" aria-labelledby="posterModalLabel<?php echo e($program->id); ?>" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-body p-0">
                                <img src="<?php echo e(asset($program->poster)); ?>" alt="Large Poster" class="img-fluid w-100">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="event-details">
                    ...
                    <a href="<?php echo e(route('participate.create', ['program' => $program->id])); ?>" class="btn btn-primary">Participate</a>
                    <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cuba\UTMConnect\resources\views/dashboard.blade.php ENDPATH**/ ?>